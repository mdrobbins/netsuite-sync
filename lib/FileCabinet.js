...
function init(env) { nsConf = eval(secureConfig.decryptFile(env + "_NetSuiteConfig.js.enc")); }
 ...
 */
module.exports.postFile = function (filename, description, folder, callback,netsuite_environment, custom_data) {
